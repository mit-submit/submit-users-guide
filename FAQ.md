...
it means you converted wrong certificate into the pem format.

Then when you have created a proxy send an e-mail to maxi@mit.edu including the output of the

       voms-proxy-info -all

command. Please do not forget to cc the leader of the LNS research group and also explicitely say what experiment you work on.
